...
source: "https://capacitorjs.com/docs/plugins/tutorial/ios-implementation"
author:
published:
created: 2025-09-24
...
> **Prerequisite:** Familiarize yourself with the [Capacitor Custom Native iOS Code documentation](https://capacitorjs.com/docs/ios/custom-code) before continuing.
...
Finally, follow [these instructions](https://capacitorjs.com/docs/ios/custom-code#register-the-plugin) to:
...
iOS will let us know when a user rotates their device through the [NotificationCenter](https://developer.apple.com/documentation/foundation/notificationcenter), when UIDevice fires the `orientationDidChangeNotification` event.
